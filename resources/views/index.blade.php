													...
													<div class="m_dropdown-login dropdown-menu login-content">
														<div class="clearfix ml-3">
															...
															<li class="avata-item">
																...
																<li class="link-item"><a ><i class="fa fa-shopping-cart"></i>My orders</a></li>
																<li class="link-item"><a ><i class="fa fa-heart"></i>My Wishlist</a></li>
																<li class="link-item"><a ><i class="fa fa-exchange"></i>My Compare</a></li>
																<li class="link-item"><a href="{{route('page.Contact')}}"><i class="fa fa-life-ring"></i>Support</a></li>
